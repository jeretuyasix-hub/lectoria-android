...
export function useReaderEngine(bookRecord:BookRecord,onCenterTap:()=>void,onOfferHistory:()=>void){
  ...
  return{host,stage,rendition,settings,setSettings,progress,location,chapter,toc,selectedText,nearby,context,limit,setLimit,minutes,navigatePage,saveHighlight,removeHighlight,clearSelection}
}
